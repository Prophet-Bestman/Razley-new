...
export const SliderOneData = [
...

  {
    image: sliderOne2,
    title: "High Quality  \n Printing Service",
    subText: "Uncompromising dedication to quality",
    button: {
      label: "Our Pricing",
      url: "/pricing",
    },
...
export const AboutTwoData = {
  sectionContent: {
    subText: "Welcome to Razley Prints",
    title: "You Dream it. \n We Print it.",
    textAlignment: "left",
  },
  content:
    "Turning your ideas into pages, fliers banners, stationaries and the likes requires a professional approach and only a reputed book printing press can do it right. \n \n We love great design and believe it can work wonders for every business. That’s why we make it simple to create beautiful, expertly crafted business stationery.",
  url: "/about",
  image: aboutTwo1,
};
...
export const TestimonialsOneData = [
  {
    image: testimonials1,
    content:
      "I have known this brand for integrity. Integrity with quality, style, timeliness. This is due to their excellent service, competitive pricing and customer support.",
    name: "Light Ihesiulo",
  },
  {
    image: testimonials2,
    content:
      "Razley Prints was introduced to me by a friend of mine and honestly, working with them has been one of the best things I have decided to do. They represent nothing but premium quality.",
    name: "Prophet Bestman",
  },
];
...
export const FooterAboutData = {
  title: "About Razley Prints",
  text: "Razley Prints is a premium Template for Digital Agencies, Start Ups, Small Business and a wide range of other agencies.",
};
...
export const FooterContactData = {
  ...
  infos: [
    {
      text: "0703 607 0751",
      url: "tel:+2347036070751",
    },
    {
      text: "0814 155 9538",
      url: "tel:+2348141559538",
    },
    {
      text: "razleyprints.ng@gmail.com",
      url: "mailto:razleyprints.ng@gmail.com",
    },
    {
  ...
  social: [
    {
      ...
      url: "https://www.instagram.com/razleyprints.ng",
    },
    // {
    //   icon: "fab fa-pinterest",
    //   url: "#",
